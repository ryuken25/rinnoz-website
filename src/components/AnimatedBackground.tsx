export function AnimatedBackground() {
  return <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
    <div className="absolute left-[7%] top-28 h-72 w-72 rounded-full bg-lavender/10 blur-3xl" />
    <div className="absolute right-[8%] top-44 h-80 w-80 rounded-full bg-blush/10 blur-3xl" />
    <div className="absolute bottom-20 left-1/3 h-96 w-96 rounded-full bg-violet/10 blur-3xl" />
